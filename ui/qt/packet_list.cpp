...
const QVector<PacketListRecord*> &PacketList::physicalRows() const
{
    return packet_list_model_->physicalRows();
}

const QVector<PacketListRecord*> &PacketList::visibleRows() const
{
    return packet_list_model_->visibleRows();
}

const QVector<PacketListRecord*> &PacketList::newVisibleRows() const
{
    return packet_list_model_->newVisibleRows();
}
