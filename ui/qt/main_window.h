...
typedef QVector<PacketListRecord*> QPacketListRecord;
typedef QVector<VectorLabelText> QVectorLabelText;

struct StringListLabelText
{
    QString labelText;
    QVector<StringListLabelText> vecLabelText;
};

typedef QVector<StringListLabelText> QStringListLabelText;
...
public:
    int init();
    const QPacketListRecord &physicalRows() const;
    QStringListLabelText getItem(int i) const;

public:
    void getItem(const QVectorLabelText &vecLabelText, StringListLabelText &listLabelText) const;
    void getItem(const QVectorLabelText &vecLabelText, QStringListLabelText &listLabelText) const;
