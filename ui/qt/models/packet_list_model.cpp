...
const QVector<PacketListRecord*> &PacketListModel::physicalRows() const
{
    return physical_rows_;
}

const QVector<PacketListRecord*> &PacketListModel::visibleRows() const
{
    return visible_rows_;
}

const QVector<PacketListRecord*> &PacketListModel::newVisibleRows() const
{
    return new_visible_rows_;
}
